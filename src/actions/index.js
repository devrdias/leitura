import { addComment, deleteCommentAPI, deletePostAPI, fetchAllPostsAPI, fetchCategoriesAPI, fetchCommentsAPI, fetchPostDetailAPI, insertPostAPI, registerVoteComment, registerVotePost, updateCommentAPI, updatePostAPI } from '../api';
...
export const sendCommentVote = (commentId, option) => dispatch =>
	registerVoteComment(commentId, option)
		.then(response => response.json())
